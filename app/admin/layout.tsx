    ...
    <div style={{ minHeight: "100vh", background: "#faf7f5", fontFamily: "system-ui, sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div style={{ width: 1, height: 20, background: "#e5e2df" }} />
          <a href="/admin" style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#888", textDecoration: "none" }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><rect x="1" y="1" width="6" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><rect x="9" y="1" width="6" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><rect x="1" y="9" width="6" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><rect x="9" y="9" width="6" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.3"/></svg>
            Dashboard
          </a>
          <a href="/admin/brain" style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#888", textDecoration: "none" }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6.5" stroke="currentColor" strokeWidth="1.3"/><path d="M8 4v4l2.5 2.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
            Brain
          </a>
        </div>
        <button
