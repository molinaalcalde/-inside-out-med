  ...
  return (
    <nav
      ...
      style={{
        ...
        background: scrolled ? "rgba(14,12,18,0.85)" : "transparent",
        backdropFilter: scrolled ? "blur(20px)" : "none",
        WebkitBackdropFilter: scrolled ? "blur(20px)" : "none",
        borderBottom: scrolled ? "1px solid rgba(245,237,232,0.08)" : "1px solid transparent",
      }}
    >
      {/* Logo */}
      ...
      <a
        href="#cta"
        className="btn-rose hidden md:inline-flex"
