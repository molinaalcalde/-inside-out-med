...
const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "scroll.s3.s": "Hidratación, inflamación, colágeno — dato por dato.",
    "scroll.s4.h": "Resultado: aparenta 45.",
    "scroll.s4.s": "+3 años por encima de su edad real.",
    "scroll.s5.h": "Con su plan, volverá a 42.",
    "scroll.s5.s": "En 12 semanas. Con productos que funcionan para SU piel.",
    ...
    "scroll.panel.hydration": "Hidratación",
    "scroll.panel.collagen": "Salud del colágeno",
    "scroll.panel.recovery": "Con su plan personalizado puede volver a",
    "scroll.panel.orLess": "42 o menos",
    ...
    "how.s2.body": "Hidratación, colágeno, inflamación, protección solar, uniformidad y más. Zona por zona, dato por dato.",
  ...
  en: {
    ...
    "scroll.s3.s": "Hydration, inflammation, collagen — metric by metric.",
    "scroll.s4.h": "Result: She Looks 45.",
    "scroll.s4.s": "+3 years above her real age.",
    "scroll.s5.h": "With Her Plan, She'll Be Back to 42.",
    "scroll.s5.s": "In 12 weeks. With products that work for HER skin.",
    "scroll.label": "InsideOutMed",
    ...
    "scroll.panel.hydration": "Hydration",
    ...
    "how.s2.body": "Hydration, collagen, inflammation, sun protection, uniformity and more. Zone by zone, metric by metric.",
